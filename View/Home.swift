...
//  SleepTime
//
//  Created by SangWoo on 2022/02/10.
//
...
struct Home: View {
        ...
        GeometryReader { proxy in
            ...
            ZStack {
                ...
                ZStack {
                    ...
                    ForEach(1...60, id: \.self) { index in
                        Rectangle()
                            ...
                            .offset(y: (width - 60) / 2)
                            .rotationEffect(.init(degrees: Double(360 / 60 * index)))
                    }
                ...
                Image(systemName: "moon.fill")
                    ...
                    // Rotatign Image inside the Circle
                    .rotationEffect(.init(degrees: 90))
                    .rotationEffect(.init(degrees: -startAngle))
                    .background(.white, in: Circle())
                    // Move to right & rotating
                    .offset(x: width / 2)
    ...
    func onDrag(value: DragGesture.Value, fromSlider: Bool = false) {
        //MARK: Converting Translating into Angle
    ...
    func getTimeDifference() -> (Int, Int) {
        ...
        var hour = result.hour ?? 0
        if hour <= 0 { hour = hour + 12}
        var minute = result.minute ?? 0
